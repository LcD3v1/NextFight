...
from nextfight.modules.admin.api.router import router as admin_router
...
from nextfight.modules.identity.api.router import (
    profile_router,
)
from nextfight.modules.identity.api.router import (
...
def build_router() -> APIRouter:
    ...
    router.include_router(profile_router, prefix="/api/v1")
